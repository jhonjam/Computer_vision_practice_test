...
parser.add_argument(
    "--weight_folder",
    type=str,
    default="C:/Users/jhonj/Downloads/prova_vision_computacional/files_yolov4/",
...
parser.add_argument(
    "--res_dir",
    default="C:/Users/jhonj/Downloads/prova_vision_computacional/results_object_detection",
...
def main(config):
    ...
    coconames = os.path.join(config.names, "cogumelos.names")
